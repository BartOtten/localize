defmodule Localize.PhoenixRoutes do
  @moduledoc """
  This module builds the configuration for `Routex` to build localized routes.
  ...
  **Example:**
  ...
  alias Localize.Parser
  alias Localize.Registry
  alias Routex.Attrs
