defmodule Localize.PhoenixRuntime.Parser do
  @moduledoc """
  ...
  alias Localize.PhoenixRuntime.Types
  ...
  defp parse_locale_with_quality(locale_string) do
    case locale_string_to_list(locale_string) do
      ...
      [locale] ->
        case Localize.Parser.parse_locale(locale) do
          nil -> nil
  ...
  defp parse_with_explicit_quality(locale, quality) do
    with parsed_locale = %{} <- Localize.Parser.parse_locale(locale),
